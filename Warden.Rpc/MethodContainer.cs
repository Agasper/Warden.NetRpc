...
namespace Warden.Rpc
{
    public class MethodContainer
    {
        ...
        readonly static ConcurrentDictionary<Type, DTaskResultDelegate> taskResultsCache = new ConcurrentDictionary<Type, DTaskResultDelegate>();
        ...
        object InvokeInternal(object entity, params object[] arguments)
        {
            if (arguments.Length != Parameters.Length)
                throw new RemotingException($"Invalid method {MethodInfo.DeclaringType.Name}.{MethodInfo.Name} parameters count");
